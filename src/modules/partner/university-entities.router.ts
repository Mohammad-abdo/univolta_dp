...
router.get("/departments", requirePartner, async (req: any, res, next) => {
  try {
...
// Create department
router.post("/departments", requirePartner, async (req: any, res, next) => {
  try {
...
// Update department
router.put("/departments/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
// Delete department
router.delete("/departments/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
router.get("/semesters", requirePartner, async (req: any, res, next) => {
  try {
...
// Create semester
router.post("/semesters", requirePartner, async (req: any, res, next) => {
  try {
...
// Update semester
router.put("/semesters/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
// Delete semester
router.delete("/semesters/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
router.get("/educational-years", requirePartner, async (req: any, res, next) => {
  try {
...
router.post("/educational-years", requirePartner, async (req: any, res, next) => {
  try {
...
router.put("/educational-years/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
router.delete("/educational-years/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
router.get("/degrees", requirePartner, async (req: any, res, next) => {
  try {
...
// Create degree
router.post("/degrees", requirePartner, async (req: any, res, next) => {
  try {
...
// Update degree
router.put("/degrees/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
...
// Delete degree
router.delete("/degrees/:id", requirePartner, async (req: any, res, next) => {
  try {
    const { id } = req.params;
