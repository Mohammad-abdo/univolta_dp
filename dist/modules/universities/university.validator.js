...
export const updateUniversitySchema = createUniversitySchema.partial().refine((data) => Object.keys(data).length > 0, { message: "At least one field must be provided" });
//# sourceMappingURL=university.validator.js.map