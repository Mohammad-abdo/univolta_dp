 ...
 */
export async function createOperationAlert(operation, resource, resourceName, resourceId, userId, universityId, metadata) {
    const typeMap = {
 ...
 */
export async function createStatusChangeAlert(resource, resourceName, resourceId, oldStatus, newStatus, userId, universityId, metadata) {
    return createAlert({
 ...
 */
export async function createPaymentAlert(title, message, resourceId, userId, universityId, metadata) {
    return createAlert({
